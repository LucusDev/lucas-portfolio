...
import { personalInfo, skills, recommendation } from "@/data/portfolio";
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
              <ScrollReveal className="lg:col-span-3 space-y-6">
                ...
                <p className="text-muted leading-relaxed">
                  I&apos;m a Flutter and full-stack developer passionate about
                  building well-architected, performant applications across
                  mobile, web, and desktop. I focus on clean architecture, great
                  user experience, and writing maintainable code. I&apos;ve
                  shipped apps with 10K+ downloads, led Flutter migrations at
                  scale, and built custom native integrations.
                </p>
              ...
              <div className="lg:col-span-2">
                <div className="rounded-xl border border-border bg-card p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
                  <div>
                    <p className="text-sm font-medium text-accent mb-1 uppercase tracking-wide">
                      Recommendation
                    </p>
                  ...
                  <a
                    href={recommendation.pdfFile}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-foreground text-background rounded-full text-xs font-medium hover:opacity-90 transition-opacity shrink-0 w-full sm:w-auto justify-center"
                  >
